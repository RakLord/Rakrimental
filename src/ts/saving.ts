    ...
    async load(game: Game) {
        ...
        try {
            ...
            if (gameState) {
                ...
                this.game.layers.start.milestones.increasePointsPerClick.timesClicked = new Decimal(gameState.layers.start.milestones.increasePointsPerClick.timesClicked);
